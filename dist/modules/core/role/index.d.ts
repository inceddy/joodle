...
interface RoleAssignment {
     ...
     */
    contextlevel?: "block" | "course" | "coursecat" | "system" | "user" | "module";
    /**
...
export default class RoleModule extends Module {
     ...
     * @async
     */
    assignRoles(...assignments: RoleAssignment[]): Promise<FunctionResponse>;
    /**
     ...
     * @async
     */
    unassignRoles(...unassignments: RoleAssignment[]): Promise<FunctionResponse>;
}
export {};
